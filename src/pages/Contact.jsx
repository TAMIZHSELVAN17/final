...
const ContactDetails = () => {
  const contactItems = [
    ...
    },
    {
      ...
      link: 'mailto:daascomputers@gmail.com',
    },
  ];
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        'https://daas-k7im.onrender.com/api/customers/contact',
        formData
      );

      toast.success('Daas Computers received your message!');
  ...
  return (
    <div className="bg-blue-100 min-h-screen px-2 sm:px-4 py-1">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-5">
        ...
        <motion.div
          className="bg-white shadow rounded-lg p-4 h-full flex flex-col justify-center"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: false, amount: 0.3 }}
          variants={fadeInUp}
